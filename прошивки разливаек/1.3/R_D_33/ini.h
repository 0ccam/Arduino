...
#define Hstrt_mm    320  // Фактическая высота вилки от стола в мм при запуске станка.
#define Hmax_mm     256   // Максимально-возможная высота подъёма вилки.
...
#define Vimp        9.2     // Количество мл для одной бутылки в одном импульсе от датчика насоса.
...
#define Kflw        (float)   ((dV * 1.35) / (dH * Vimp)) // Коэффициент следования длительности шага за длительностью импульса ДПР.
